...
$findByCertificationCode = $queryService->findByCertificationCode(
    $hashEmailCertificationCode
);
$session->setUserId(new UserId($findByCertificationCode['user_id']));

$status = [
    'data' => [
        'userId' => $findByCertificationCode['user_id'],
